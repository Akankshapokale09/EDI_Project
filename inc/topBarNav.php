      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-dark text-light" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
              <a href="./login.php" class="mx-2 text-light text-decoration-none font-weight-bolder">Customer Login</a> | 
              <a href="./vendor" class="mx-2 text-light text-decoration-none font-weight-bolder">Farmer Login</a> | 
